...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public int findMinimum( int column )
   {
    ...
    // Write your code here:
	   int l=intArray[0][column],r=0;
	   for(int i=1;i<ROWS;i++) {
		   if(l>intArray[i][column]) {
			   l=intArray[i][column];
			   r=i;
		   }
	   }
	   animate(r,column,intArray[r][column]);
      return l; // replace this line with your return statement
   }
